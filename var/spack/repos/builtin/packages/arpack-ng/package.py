...
class ArpackNg(Package):
    ...
    * Example driver routines that may be used as templates to implement
    ...
    depends_on('blas')
    depends_on('lapack')
    depends_on('automake', when='@3.3.0', deptypes='build')
    depends_on('autoconf', when='@3.3.0', deptypes='build')
    depends_on('libtool@2.4.2:', when='@3.3.0', deptypes='build')
    depends_on('cmake@2.8.6:', when='@3.4.0:', deptypes='build')
