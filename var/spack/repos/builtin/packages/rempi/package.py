...
class Rempi(AutotoolsPackage):
    ...
    url      = "https://github.com/PRUNERS/ReMPI/archive/v0.1.0.tar.gz"

    #version("0.1.0", "d0ab2ccaa84684736f1f5078372c5b00")
    version('0.1.1b', git='https://github.com/PRUNERS/ReMPI.git',
